...
#SBATCH -J 3oo5highest_dist       # job name to display in squeue
#SBATCH -o output-3oo5highest_dist.txt    # standard output file
#SBATCH -e error-3oo5highest_dist.txt     # standard error file
#SBATCH -p htc      # requested partition
#SBATCH --mem=500G          # Total memory required
#SBATCH -t 1400              # maximum runtime in minutes
#SBATCH -D /users/maboelela/Research/Qualification_Task/DIPZ_Workflow/3oo5highest_dist  #sets the working directory where the batch script should be run
